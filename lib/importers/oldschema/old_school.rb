...
#  scope :school_subset,  where(:schoolID => [91,215,229,221,98,830,483,412,96,633,873,538,121,94,277]).where('status_id = 200 and ad_profile < 21')
  scope :school_subset,  where(:schoolID => [98,215,221,98,830,483,523]).where('status_id = 200 and ad_profile < 20')
#light#  scope :school_subset,  where(:schoolID => [98,215,221,98]).where('status_id = 200 and ad_profile < 20')
