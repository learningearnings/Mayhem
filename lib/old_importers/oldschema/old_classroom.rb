class OldClassroom < ActiveRecord::Base
  ...
  has_many :classroom_details, :class_name => 'OldClassroomDetail', :foreign_key => :classroomID, :source => :old_classroom
  ...
  has_many :students, :through => :classroom_details, :class_name => "OldUser", :foreign_key => :userID
