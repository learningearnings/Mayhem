var school_admin_overview = {
  ...
  steps: [{
    ...
    content: "Classrooms allow you to create groups of students so you can quickly find them and create rewards just for them.",
    placement: "bottom"
  }, {
    ...
    content: "Here we'll add a new student since you don't already have one, but in the future you can also add existing students to a classroom.  Students can be in many classrooms, and you can create as many classrooms as you like.",
    placement: "top"
  }, {
    ...
    content: "This is where you will add your new student's information. If you like you can create a fictional student and delete the account later or you can use a real student.",
    placement: "left",
    showNextButton: false
  }, {
    ...
    content: "The Auto-Credits tab allows you to setup automatically delivered weekly credits to reward good behavior.  You must be syned with an iNow school to use this feature.",
    placement: "top",
    onShow: function() {
