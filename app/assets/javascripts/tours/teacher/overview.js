var teacher_overview = {
  ...
  steps: [{
    ...
    content: "Enter your new student's information. If you like you can create a fictional student and delete the account later or you can add a real student.",
    placement: "left",
    showNextButton: false,
    showPrevButton: true,
    onPrev: function() {
