...
module Teachers
  class Reward
    ...
    attr_accessible :name, :description, :price, :classrooms, :template_image, :image, :on_hand, :category, :school_id, :classroom_id, :min_grade, :max_grade, :time_frame
    ...
    attr_accessor :min_grade, :max_grade, :locker_sticker, :time_frame
