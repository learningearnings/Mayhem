    ...
    class StudentCheckingImporter < BaseImporter
      ...
      def transfer_points(datum)
        begin
          ...
          @credit_manager.transfer_credits('Imported Legacy Points', @credit_manager.main_account, student.checking_account, -(student.checking_account.balance))
          @credit_manager.transfer_credits('Imported Legacy Points', @credit_manager.main_account, student.checking_account, datum[:points][:points])
        rescue Exception => e
