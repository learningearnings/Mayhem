        ...
        klass.class_eval do
          ...
          def self.define_state_machine!
            ...
            state_machine :state, :initial => :cart do
              ...
              ## Add a method to the order states called "refunded"
              event :refund do
                transition :to => :refunded, :from => :shipped
              end
              ...
              # add callback to restock items to LE store after refund is issued
              after_transition :to => :refunded, :do => :after_refund
